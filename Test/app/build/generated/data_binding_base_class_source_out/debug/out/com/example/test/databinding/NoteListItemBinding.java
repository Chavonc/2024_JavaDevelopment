...
public final class NoteListItemBinding implements ViewBinding {
  ...
  private NoteListItemBinding(@NonNull RelativeLayout rootView, @NonNull CheckBox noteCheckBox,
      @NonNull TextView noteTextView) {
  ...
  public static NoteListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.note_textView;
      TextView noteTextView = ViewBindings.findChildViewById(rootView, id);
      if (noteTextView == null) {
        break missingId;
      }

      return new NoteListItemBinding((RelativeLayout) rootView, noteCheckBox, noteTextView);
    }
